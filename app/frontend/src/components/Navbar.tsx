...
import { Bike, Settings, LogOut, LogIn, Menu } from 'lucide-react';
...
const Navbar: FC<NavbarProps> = ({ onToggleSidebar, sidebarCollapsed }) => {
      ...
      <div className="flex items-center gap-3">
        {onToggleSidebar && (
          <button
            ...
            className="hidden md:flex w-9 h-9 items-center justify-center rounded-xl bg-panel border border-border-glass-subtle text-muted hover:text-text hover:bg-panel-hover transition-all"
      ...
      <div className="flex items-center gap-4">
        {isAuthenticated ? (
          <>
            ...
            <div className="hidden sm:flex items-center gap-2 bg-panel border border-border-glass-subtle p-1 rounded-xl group hover:bg-panel-hover transition-all cursor-pointer">
